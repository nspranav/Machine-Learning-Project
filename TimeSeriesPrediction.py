...
classifier_dictionary_list = [
    ...
    ["SVM_RBF", make_pipeline(preprocessing.StandardScaler(), PCA(n_components=PCA_COMPONENT_NO), svm.SVC(kernel='rbf', C = 1)), "svm.SVC kernel=rbf"],
    ...
    ["SVM_SIGMOID", make_pipeline(preprocessing.StandardScaler(), PCA(n_components=PCA_COMPONENT_NO), svm.SVC(kernel='sigmoid', C = 1)), "svm.SVC kernel=sigmoid"],
